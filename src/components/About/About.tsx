    ...
    <div className='about' id='about'>
      <div className='about__left'>
        ...
        <div className='about__description'>
          ...
          {' '}
          and I’m a CS major and an undergraduate student at DePauw university in the United States. I have successfully completed multiple software engineering (SDE) internships and served as the president of the International Computer Science Association at DePauw University. Additionally, I have teaching experience in Computer Science at renowned universities such as UPenn for their high school programs.
          {' '}
